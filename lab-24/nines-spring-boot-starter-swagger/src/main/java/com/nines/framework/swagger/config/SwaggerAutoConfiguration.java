...
import com.nines.framework.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
@ConditionalOnProperty(prefix = "nines.swagger", value = "enable", matchIfMissing = true)
